...
@st.cache_data
def load_movie_data():
    return pd.read_csv("imdb_movies.csv")  # Ensure the file exists
...
if st.button("Search"):
    if movie_name:
        ...
        if movie_details is not None:
            ...
            # ✅ Predict IMDb Rating using LDA
            movie_tfidf = tfidf_vectorizer.transform([movie_details["description"]]).toarray()
